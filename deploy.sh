...
write_env_file() {
  ...
  GIT_REPO=$(prompt_var GIT_REPO "App Git repo (URL, used by Dockerfile.git)" "https://github.com/IAteNoodles/stock_docker.git")
  GIT_REF=$(prompt_var GIT_REF "App Git ref (branch/tag/commit)" "master")
  cat >"$ENV_FILE" <<EOF
